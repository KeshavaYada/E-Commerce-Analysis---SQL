...
1. **Top Selling Products** 🏆  
   ...
   ![Query](https://github.com/KeshavaYada/E-Commerce-Analysis---SQL/blob/main/Codefiles/Problem_1.sql)

2. **Revenue by Category** 💰  
   - Calculate total revenue generated by each product category.
   - **Challenge**: Include the percentage contribution of each category to total revenue.
   ![Query](https://github.com/KeshavaYada/E-Commerce-Analysis---SQL/blob/main/Codefiles/Problem_2.sql)
3. **Average Order Value (AOV)** 📈  
   - Compute the average order value for each customer.
   - **Challenge**: Include only customers with more than 5 orders.
   ![Query](https://github.com/KeshavaYada/E-Commerce-Analysis---SQL/blob/main/Codefiles/Problem_3.sql)
4. **Monthly Sales Trend** 📅  
   - Query monthly total sales over the past year.
   - **Challenge**: Display the sales trend, including current month sales and last month sales.
    ![Query](https://github.com/KeshavaYada/E-Commerce-Analysis---SQL/blob/main/Codefiles/Problem_4.sql)
5. **Customers with No Purchases** ❌  
   - Find customers who have registered but never placed an order.
   - **Challenge**: List customer details and the time since their registration.
     ![Query](https://github.com/KeshavaYada/E-Commerce-Analysis---SQL/blob/main/Codefiles/Problem_5.sql)
6. **Least-Selling Categories by State** 🚨  
   - Identify the least-selling product category for each state.
   - **Challenge**: Include the total sales for that category within each state.
   ![Query](https://github.com/KeshavaYada/E-Commerce-Analysis---SQL/blob/main/Codefiles/Problem_6.sql)
7. **Customer Lifetime Value (CLTV)** 💸  
   - Calculate the total value of orders placed by each customer over their lifetime.
   - **Challenge**: Rank customers based on their CLTV.
     ![Query](https://github.com/KeshavaYada/E-Commerce-Analysis---SQL/blob/main/Codefiles/Problem_7.sql)
8. **Inventory Stock Alerts** ⚠️  
   - Query products with stock levels below a certain threshold (e.g., less than 10 units).
   - **Challenge**: Include the last restock date and warehouse information.
    ![Query](https://github.com/KeshavaYada/E-Commerce-Analysis---SQL/blob/main/Codefiles/Problem_8.sql)
9. **Shipping Delays** 🕒  
   - Identify orders where the shipping date is more than 3 days after the order date.
   - **Challenge**: Include customer, order details, and delivery provider.
     ![Query](https://github.com/KeshavaYada/E-Commerce-Analysis---SQL/blob/main/Codefiles/Problem_9.sql)
10. **Payment Success Rate** 💳  
    - Calculate the percentage of successful payments across all orders.
    - **Challenge**: Include breakdowns by payment status (e.g., failed, pending).
     ![Query](https://github.com/KeshavaYada/E-Commerce-Analysis---SQL/blob/main/Codefiles/Problem_10.sql)
11. **Top Performing Sellers** 🥇  
    - Find the top 5 sellers based on total sales value.
    - **Challenge**: Include both successful and failed orders, and display the percentage of successful orders.
     ![Query](https://github.com/KeshavaYada/E-Commerce-Analysis---SQL/blob/main/Codefiles/Problem_11.sql)
12. **Product Profit Margin** 📊  
    - Calculate the profit margin for each product (difference between price and cost of goods sold).
    - **Challenge**: Rank products by their profit margin, from highest to lowest.
    ![Query](https://github.com/KeshavaYada/E-Commerce-Analysis---SQL/blob/main/Codefiles/Problem_12.sql)
13. **Most Returned Products** 🔄  
    - Query the top 10 products by the number of returns.
    - **Challenge**: Display the return rate as a percentage of total units sold for each product.
     ![Query](https://github.com/KeshavaYada/E-Commerce-Analysis---SQL/blob/main/Codefiles/Problem_13.sql)
15. **Inactive Sellers** 🛑  
    - Identify sellers who haven’t made any sales in the last 6 months.
    - **Challenge**: Show the last sale date and total sales from those sellers.
     ![Query](https://github.com/KeshavaYada/E-Commerce-Analysis---SQL/blob/main/Codefiles/Problem_15.sql)
16. **Returning vs. New Customers** 🔄👤  
    ...
    - **Challenge**: List customer ID, name, total orders, and total returns.
     ![Query](https://github.com/KeshavaYada/E-Commerce-Analysis---SQL/blob/main/Codefiles/Problem_16.sql)
17. **Top 5 Customers by Orders in Each State** 🌎  
    - Identify the top 5 customers with the highest number of orders for each state.
    - **Challenge**: Include the number of orders and total sales for each customer.
      ![Query](https://github.com/KeshavaYada/E-Commerce-Analysis---SQL/blob/main/Codefiles/Problem_17.sql)
18. **Revenue by Shipping Provider** 🚚  
    - Calculate the total revenue handled by each shipping provider.
    - **Challenge**: Include the total number of orders and average delivery time for each provider.
      ![Query](https://github.com/KeshavaYada/E-Commerce-Analysis---SQL/blob/main/Codefiles/Problem_18.sql)
19. **Top 10 Products with Decreasing Revenue** 📉  
    ...
    - **Challenge**: Return product ID, product name, category name, 2022 revenue, 2023 revenue, and decrease ratio.
     ![Query](https://github.com/KeshavaYada/E-Commerce-Analysis---SQL/blob/main/Codefiles/Problem_19.sql)
